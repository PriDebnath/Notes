describe('Note CRUD', () => {
  ...
  //   cy.get(`[aria-label="${testData.tag_2}"]`).click()
  //   cy.get("div.fixed > div > div > div:nth-of-type(1) button:nth-of-type(3) > svg").click()
  //   cy.get("a > button").click()
  // })

  it('Delete the note', () => {
     cy.get("[aria-label=\"delete-1\"]").click(16.328125, 15.015625)
    cy.get("[aria-label=\"delete\"]").click(47.703125, 21.5)
  })
})
